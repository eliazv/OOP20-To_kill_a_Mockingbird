...
public class EndGameViewImpl implements View {
    ...
    class EndGamePanel extends JLayeredPane {
        ...
        EndGamePanel() {
            ...
            final ImageIcon background = new ImageIcon(new ImageIcon("resources/GameOver.png").getImage().getScaledInstance(400, 500, Image.SCALE_SMOOTH));

            lblBackground = new JLabel(background);
            lblBackground.setBounds(rLblBackground);
            add(lblBackground, DEFAULT_LAYER);
            final ImageIcon restartImage = new ImageIcon(new ImageIcon("resources/RestartButton.png").getImage().getScaledInstance(150, 30, Image.SCALE_SMOOTH));
            final ImageIcon exitImage = new ImageIcon(new ImageIcon("resources/ExitButton2.png").getImage().getScaledInstance(150, 30, Image.SCALE_SMOOTH));
